...
Firebird.attach(options, async function (err, db) {
  ...
  // setTimeout(async () => {
  //   await checkVendasOnDemand(err, db, moment("01/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("2/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("3/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("4/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("5/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("6/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("7/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("8/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("9/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //   await checkVendasOnDemand(err, db, moment("10/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //   await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("11/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("12/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("13/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("14/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("15/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("16/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("17/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("18/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("19/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("20/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("21/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("22/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("23/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("24/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
  //    await checkVendasOnDemand(err, db, moment("25/11/2023", "DD/MM/YYYY").format('D.M.YYYY'))
  //    await criarDelay(1000)
