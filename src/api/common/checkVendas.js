...
function checkVendas(erro, db) {
  return new Promise(async function (resolve, reject) {
    ...
    select
    t.vendedor,
    sum (T.custo) as Total_Custo, cast('now' as date) as DATA_VENDAS,
    ...
    from tb_pedidos t
    where t.d_baixa = cast('now' as date)
      and t.situacao = 'PD'
      group by t.vendedor;
