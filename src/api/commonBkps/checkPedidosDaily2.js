...
function checkPedidosDaily() {
  return new Promise(async function (resolve, reject) {
   ...
   and t.situacao = 'PD'
   --and t.data_edicao async function (err, db) { cast('${moment().subtract(15, 'days').format('D.M.YYYY')}' as date) and cast('${moment().add(2, 'days').format('D.M.YYYY')}' as date)
